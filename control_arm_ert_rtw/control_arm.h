...
typedef struct {
  ...
  real_T Integrator_DSTATE_o;          /* '<S50>/Integrator' */
  real_T UnitDelay7_DSTATE;            /* '<S1>/Unit Delay7' */
  real_T Integrator_DSTATE_e;          /* '<S154>/Integrator' */
  real_T UnitDelay9_DSTATE;            /* '<S1>/Unit Delay9' */
  real_T Integrator_DSTATE_h;          /* '<S206>/Integrator' */
} DW;
 ...
 * Block '<S47>/Integral Gain' : Eliminated nontunable gain of 1
 * Block '<S55>/Proportional Gain' : Eliminated nontunable gain of 1
